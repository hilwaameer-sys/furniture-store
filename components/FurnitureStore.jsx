...
/* 🔁 صور + نصوص السلايدر — استبدل الروابط بصورك الحقيقية */
const HERO_SLIDES = [
  {
    image: "https://images.unsplash.com/photo-1616594039964-ae9021a400a0?auto=format&fit=crop&w=1600&q=75",
  ...
  {
    image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&w=1600&q=75",
    badge: { he: "מאות ביקורות חיוביות", ar: "مئات التقييمات الإيجابية" },
    title: { he: "איכות שתרגישו כל לילה", ar: "جودة ستحسّها كل ليلة" },
    sub:   { he: "מזרנים ומיטות ברמה גבוהה", ar: "تخوت ومراتب بمستوى عالي" },
  },
  {
    image: "https://images.unsplash.com/photo-1540518614846-7eded433c457?auto=format&fit=crop&w=1600&q=75",
...
const products = [
  ...
  { id:"chair-elegant", category:"chairs",
    ...
    desc:{ he:"כיסא מרופד אלגנטי לפינת אוכל ולסלון. בד עמיד ונוח.", ar:"كرسي مبطّن أنيق لغرفة الطعام والصالون. قماش متين ومريح." },
    basePrice:250, oldPrice:390,
  ...
  { id:"chair-dining", category:"chairs",
    ...
    desc:{ he:"כיסא קלאסי עם רגלי עץ מלא וריפוד איכותי.", ar:"كرسي كلاسيكي مع أرجل خشب طبيعي وتبطين عالي الجودة." },
  ...
  { id:"chair-modern", category:"chairs",
    ...
    desc:{ he:"כיסא בעיצוב מינימליסטי למשרד ולבית.", ar:"كرسي بتصميم عصري وخطوط بسيطة للمكتب والبيت." },
  ...
  { id:"bed-upholstered", category:"beds",
    ...
    desc:{ he:"מיטה מרופדת בריפוד רך ויוקרתי עם ראש מיטה מעוצב.", ar:"تخت مبطّن بقماش ناعم وفاخر مع ظهر مزخرف." },
  ...
  { id:"salon-royal", category:"salons",
    ...
    desc:{ he:"סלון רויאל יוקרתי בהתאמה אישית. בחרו מידה, צבע ובד.", ar:"صالون رويال فاخر بتفصيل حسب الطلب." },
  ...
  { id:"salon-corner", category:"salons",
    ...
    desc:{ he:"סלון פינתי מרווח שמנצל כל פינה בחלל.", ar:"صالون زاوية واسع يستغل كل ركن في المساحة." },
